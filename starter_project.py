# starter_project.py (Versão Corrigida 2.0)
import subprocess
import os
import sys
...
services:
  ...
  monitoramento:
    ...
    depends_on:
      - banco_de_dados
"""
    # A linha abaixo foi corrigida para garantir que o cliente se conecte pelo nome do serviço.
...
"""
    # Adiciona os simuladores dinamicamente
